...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $query = "INSERT INTO Company (user_id, companyName, companyAddress, contactName, companyEmail, phoneNumber, landLineNumber, region) 
                  VALUES (:user_id, :companyName, :companyAddress, :contactName, :companyEmail, :phoneNumber, :landLineNumber, :region)";
        ...
        // $stmt->bindParam(':country', $country); // Uncomment if needed
        // $stmt->bindParam(':URL', $URL); // Uncomment if needed
