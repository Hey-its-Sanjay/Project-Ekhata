        ...
        try {
            ...
            if (count($result) > 0) {
                foreach ($result as $data) {
                    echo '
                    <tr>
                        <td class="p-2">'.htmlspecialchars($data['id']).'</td>
                        ...
                        <td class="p-2">'.htmlspecialchars($data['city']).'</td>
                        <td class="p-2">
                            <a href="summary_customer.php?id='.htmlspecialchars($data['id']).'" class="btn btn-info btn-sm">View</a>
                            <a href="delete_customer.php?id='.htmlspecialchars($data['id']).'" class="btn btn-danger btn-sm" onclick="return confirmDelete()">Delete</a>
                        </td>
                    </tr>';
                }
            } else {
